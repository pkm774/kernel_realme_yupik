...
PATH="$TOP/tools/clang/host/linux-x86/clang-r383902b/bin:$PATH"
export LD_LIBRARY_PATH="$TOP/tools/clang/host/linux-x86/clang-r383902b/lib64:$LD_LIBRARY_PATH"
...
# Set tools path
TARGET_KERNEL_MAKE_ENV+="HOSTCC=${TOP}/tools/clang/host/linux-x86/clang-r383902b/bin/clang "
TARGET_KERNEL_MAKE_ENV+="HOSTCXX=${TOP}/tools/clang/host/linux-x86/clang-r383902b/bin/clang++ "
TARGET_KERNEL_MAKE_ENV+="HOSTLD=${TOP}/tools/clang/host/linux-x86/clang-r383902b/bin/ld.lld "
TARGET_KERNEL_MAKE_ENV+="CC=${TOP}/tools/clang/host/linux-x86/clang-r383902b/bin/clang "
TARGET_KERNEL_MAKE_ENV+="LLVM=${TOP}/tools/clang/host/linux-x86/clang-r383902b/bin/clang "
TARGET_KERNEL_MAKE_ENV+="LD=${TOP}/tools/clang/host/linux-x86/clang-r383902b/bin/ld.lld "
TARGET_KERNEL_MAKE_ENV+="AR=${TOP}/tools/clang/host/linux-x86/clang-r383902b/bin/llvm-ar "
TARGET_KERNEL_MAKE_ENV+="NM=${TOP}/tools/clang/host/linux-x86/clang-r383902b/bin/llvm-nm "
TARGET_KERNEL_MAKE_ENV+="OBJCOPY=${TOP}/tools/clang/host/linux-x86/clang-r383902b/bin/llvm-objcopy "
TARGET_KERNEL_MAKE_ENV+="OBJDUMP=${TOP}/tools/clang/host/linux-x86/clang-r383902b/bin/llvm-objdump "
TARGET_KERNEL_MAKE_ENV+="OBJSIZE=${TOP}/tools/clang/host/linux-x86/clang-r383902b/bin/llvm-size "
TARGET_KERNEL_MAKE_ENV+="READELF=${TOP}/tools/clang/host/linux-x86/clang-r383902b/bin/llvm-readelf "
TARGET_KERNEL_MAKE_ENV+="STRIP=${TOP}/tools/clang/host/linux-x86/clang-r383902b/bin/llvm-strip "
...
cp out/drivers/soc/oplus/system/last_boot_reason/last_boot_reason.ko out/gen_modules
...
cp out/drivers/soc/oplus/explorer/explorer.ko out/gen_modules
